...
Colors.THEMES = {
    FOREST = {
        ...
        finale_border = {1.0, 1.0, 1.0, 1},
        finale_hover = {0.8, 0.8, 0.8, 1},
        finale_glow = {1.0, 1.0, 1.0, 0.6},
    ...
    VOLCANO = {
        background = {0.3, 0.1, 0.05, 1},
        wall_border = {0.6, 0.2, 0.1, 1},
        wall_inner = {0.8, 0.4, 0.2, 1},
        wall_hover_border = {0.4, 0.15, 0.05, 1},
        wall_hover_inner = {0.7, 0.3, 0.15, 1},
        walkable_border = {0.2, 0.1, 0.05, 1},
        walkable_inner = {0.35, 0.2, 0.1, 1},
        walkable_hover_border = {0.15, 0.05, 0.02, 1},
        walkable_hover_inner = {0.25, 0.15, 0.05, 1},
        spawn_border = {0.8, 0.3, 0.1, 1},
        spawn_hover = {0.6, 0.2, 0.05, 1},
        finale_border = {1.0, 1.0, 1.0, 1},
        finale_hover = {0.8, 0.8, 0.8, 1},
        finale_glow = {1.0, 1.0, 1.0, 0.6},
        ui_background = {0.15, 0.05, 0.02, 0.9},
        ui_text = {1.0, 0.9, 0.7, 1}
    },
    
    ARCTIC = {
        background = {0.05, 0.1, 0.2, 1},
        wall_border = {0.2, 0.4, 0.6, 1},
        wall_inner = {0.4, 0.6, 0.8, 1},
        wall_hover_border = {0.1, 0.3, 0.5, 1},
        wall_hover_inner = {0.3, 0.5, 0.7, 1},
        walkable_border = {0.1, 0.15, 0.25, 1},
        walkable_inner = {0.2, 0.3, 0.4, 1},
        walkable_hover_border = {0.05, 0.1, 0.2, 1},
        walkable_hover_inner = {0.15, 0.25, 0.35, 1},
        spawn_border = {0.1, 0.4, 0.8, 1},
        spawn_hover = {0.05, 0.3, 0.6, 1},
        finale_border = {1.0, 1.0, 1.0, 1},
        finale_hover = {0.8, 0.8, 0.8, 1},
        finale_glow = {1.0, 1.0, 1.0, 0.6},
        ui_background = {0.02, 0.05, 0.1, 0.9},
        ui_text = {0.8, 0.9, 1.0, 1}
    },
    
    DESERT = {
        background = {0.3, 0.25, 0.1, 1},
        wall_border = {0.6, 0.5, 0.2, 1},
        wall_inner = {0.8, 0.7, 0.4, 1},
        wall_hover_border = {0.4, 0.35, 0.15, 1},
        wall_hover_inner = {0.7, 0.6, 0.3, 1},
        walkable_border = {0.2, 0.2, 0.1, 1},
        walkable_inner = {0.35, 0.3, 0.2, 1},
        walkable_hover_border = {0.15, 0.15, 0.05, 1},
        walkable_hover_inner = {0.25, 0.25, 0.15, 1},
        spawn_border = {0.8, 0.6, 0.2, 1},
        spawn_hover = {0.6, 0.4, 0.1, 1},
        finale_border = {1.0, 1.0, 1.0, 1},
        finale_hover = {0.8, 0.8, 0.8, 1},
        finale_glow = {1.0, 1.0, 1.0, 0.6},
        ui_background = {0.15, 0.12, 0.05, 0.9},
        ui_text = {1.0, 0.95, 0.8, 1}
    },
    
    NEBULA = {
        background = {0.05, 0.02, 0.15, 1},
        wall_border = {0.3, 0.1, 0.5, 1},
        wall_inner = {0.5, 0.2, 0.7, 1},
        wall_hover_border = {0.2, 0.05, 0.4, 1},
        wall_hover_inner = {0.4, 0.15, 0.6, 1},
        walkable_border = {0.1, 0.05, 0.2, 1},
        walkable_inner = {0.2, 0.1, 0.3, 1},
        walkable_hover_border = {0.05, 0.02, 0.15, 1},
        walkable_hover_inner = {0.15, 0.05, 0.25, 1},
        spawn_border = {0.4, 0.1, 0.8, 1},
        spawn_hover = {0.3, 0.05, 0.6, 1},
        finale_border = {1.0, 1.0, 1.0, 1},
        finale_hover = {0.8, 0.8, 0.8, 1},
        finale_glow = {1.0, 1.0, 1.0, 0.6},
        ui_background = {0.02, 0.01, 0.08, 0.9},
        ui_text = {0.9, 0.8, 1.0, 1}
    }
}
